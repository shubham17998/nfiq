...
public class SsxStats extends Nist implements ISsxStats {	
	...
	/*****************************************************
	   ssxStdDev accepts the sum of the
	   values, the sum of the squares of the values, and
	   the number of values contained in the sum and
	   returns the standard deviation of the data.
	   double sumX;  # sum of the x values
	   double sumX2; # sum of the squares of the x values
	...
	******************************************************/
	...
	/*****************************************************
	   ssxVariance accepts the sum of the values, the sum
	   of the squares of the values, and the number of
	   values contained in the sum and returns the
	   variance of the data.
	   double sumX;   # sum of the x values
	   double sumX2;  # sum of the squares of the values x
	...
	******************************************************/
	public double ssxVariance(final double sumX, final double sumX2, final int count)
	{
		...
		if (count < 2)
		{
			LOGGER.error(String.format("ERROR : ssx_variance : invalid count : %d < 2\n", count));
			return (-2.0);
		}
	...
	/*****************************************************
	   ssx accepts the sum of the values, sumX, the
	   sum of the squares of the values, sumX2 and the
