...
public class LfsUtil extends MindTct implements ILfsUtil {
	...
	private static volatile LfsUtil instance;
    public static LfsUtil getInstance() {
        if (instance == null) {
	...
	**************************************************************************
	...
	#cat:           are selected when they are detected.
	   ...
	   Output:
	      oMinMaxValue   - value of the item at each minima or maxima
	      oMinMaxType  - identifies a minima as '-1' and maxima as '1'
	      oMinMaxIndex     - index of item's position in list
	      oMinMaxAlloc - number of allocated minima and/or maxima
	      oMinMaxNumber   - number of detected minima and/or maxima
	   Return Code:
	...
	**************************************************************************/
	public int minMaxs(AtomicIntegerArray oMinMaxValue, AtomicIntegerArray oMinMaxType, AtomicIntegerArray oMinMaxIndex, 
		...
		int nMinMaxAlloc, nMinMaxNumber;
		...
		//minmax_val = (int)malloc(nMinMaxAlloc * (Integer.SIZE / Byte.SIZE));
		//minmax_type = (int)malloc(nMinMaxAlloc * (Integer.SIZE / Byte.SIZE));
		//minmax_i = (int)malloc(nMinMaxAlloc * (Integer.SIZE / Byte.SIZE));
	...
	**************************************************************************/
	...
	/*************************************************************************
	**************************************************************************
	#cat: squaredDistance - Takes two coordinate points and computes the
	...
	**************************************************************************/
	...
	/*************************************************************************
	**************************************************************************
	#cat: getValueLocationInList - Determines if a specified value is store in a list of
	...
	**************************************************************************/
	...
	/*************************************************************************
	**************************************************************************
	#cat: removeValueFromLocationInList - Takes a position index into an integer list and
	...
	**************************************************************************/
	public int removeValueFromLocationInList(final int index, AtomicIntegerArray list, final int num) {
		...
		{
			LOGGER.error(String.format("ERROR : remove_from_int_list : index out of range\n"));
			return (-370);
		}
	...
	/*************************************************************************
	**************************************************************************
	#cat: findIncrementalPositionInDoubleArray - Takes a double value and a list of doubles and
	...
	**************************************************************************/
	...
	/*************************************************************************
	**************************************************************************
	#cat: angleToLine - Takes two coordinate points and computes the angle
	...
	**************************************************************************/
	...
	/*************************************************************************
	**************************************************************************
	#cat: lineToDirection - Takes two coordinate points and computes the
	...
	#cat:            to the second.
	   Input:
	      ...
	      noOfPossibleDirs      - number of IMAP directions (in semicircle)
	   Return Code:
	...
	**************************************************************************/
	public int lineToDirection(final int fx, final int fy, final int tx, final int ty, final int noOfPossibleDirs) {
		...
		pi_factor = (double)fullNoOfDirs / pi2 ;
	...
	/*************************************************************************
	**************************************************************************
	#cat: closestDirDistance - Takes to integer IMAP directions and determines the
	...
	#cat:                    the range of directions.
	   Input:
	      ...
	      noOfPossibleDirs - the number of possible directions
	   Return Code:
