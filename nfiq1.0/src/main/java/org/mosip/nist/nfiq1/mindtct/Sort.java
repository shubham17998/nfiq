...
public class Sort extends MindTct implements ISort {
	private static volatile Sort instance;
    ...
    /*************************************************************************
	**************************************************************************
	#cat: sortIndicesIntArrayIncremental - Takes a list of integers and returns a list of
	...
	#cat:                 order.
	   ...
	   Output:
	      order   - list of indices referencing the integer list in sorted order
	...
	**************************************************************************/
	...
	/*************************************************************************
	**************************************************************************
	#cat: sortIndicesDoubleArrayIncremental - Takes a list of doubles and returns a list of
	...
	**************************************************************************/
	...
	/*************************************************************************
	**************************************************************************
	#cat: bubbleSortIntArrayIncremental2 - Takes a list of integer ranks and a corresponding
	...
	**************************************************************************/
	...
	/***************************************************************************
	**************************************************************************
	#cat: bubbleSortDoubleArrayDecremental2 - Conducts a simple bubble sort returning a list
	...
	****************************************************************************/
	public void bubbleSortDoubleArrayDecremental2(AtomicReferenceArray<Double> ranks, AtomicIntegerArray items, final int len) {
		int done = ILfs.FALSE, i, p, n, tItem;
		double tRank;
	...
	/*************************************************************************
	**************************************************************************
	#cat: bubbleSortIntArrayIncremental - Takes a list of integers and sorts them into
